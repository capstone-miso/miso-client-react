  ...
  return (
    <>
      ...
      {isClickDong ? (
        <>
          <div
            style={{ position: "fixed", top: "9%", left: "50%", zIndex: "10" }}
          >
            <Button
              variant="contained"
              onClick={() => setIsClickDong(false)}
              style={{
                backgroundColor: "orange",
                height: "42px",
                fontWeight: "700",
          ...
          <div
            style={{ position: "fixed", top: "16%", left: "50%", zIndex: "10" }}
          >
            <Button
              variant="contained"
              onClick={() => {
          ...
          <div
            style={{ position: "fixed", top: "23%", left: "50%", zIndex: "10" }}
          >
            <Button
              variant="contained"
              onClick={() => {
          ...
          <div
            style={{ position: "fixed", top: "30%", left: "50%", zIndex: "10" }}
          >
            <Button
              variant="contained"
              onClick={() => {
          ...
          <div
            style={{ position: "fixed", top: "37%", left: "50%", zIndex: "10" }}
          >
            <Button
              variant="contained"
              onClick={() => {
          ...
          <div
            style={{ position: "fixed", top: "44%", left: "50%", zIndex: "10" }}
          >
            <Button
              variant="contained"
              onClick={() => {
          ...
          <div
            style={{ position: "fixed", top: "51%", left: "50%", zIndex: "10" }}
          >
            <Button
              variant="contained"
              onClick={() => {
          ...
          <div
            style={{ position: "fixed", top: "58%", left: "50%", zIndex: "10" }}
          >
            <Button
              variant="contained"
              onClick={() => {
