...
export const getStoreRanking = async (keyWord: string, page: number, size: number) : Promise<StoreRanking> => {
  const stores = await axios.get(API.RANK_PAGE, {
    params: {
      keyword: keyWord,
      page: page,
...
export const getNextStoreRanking = async (pageUrl: string) : Promise<StoreRanking> => {
